...
namespace FujiyBlog.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_FeedController : FujiyBlog.Web.Controllers.FeedController
    {
        public T4MVC_FeedController() : base(Dummy.Instance) { }

        [NonAction]
        partial void Rss20Override(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult Rss20()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Rss20);
            Rss20Override(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void Atom10Override(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult Atom10()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Atom10);
            Atom10Override(callInfo);
            return callInfo;
        }
